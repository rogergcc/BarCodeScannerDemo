...
package com.rogergcc.barcodescannerdemo.ui.barcode
 ...
 */
internal class BarcodeReticleGraphic(overlay: GraphicOverlay) :
...
//        ripplePaint.color = ContextCompat.getColor(context, R.color.teal_200)
    ...
    override fun draw(canvas: Canvas) {
        ...
        ripplePaint.alpha = (rippleAlpha ).toInt()
        ripplePaint.strokeWidth = rippleStrokeWidth * 1.0F
        val offset = rippleSizeOffset * 1.0F
